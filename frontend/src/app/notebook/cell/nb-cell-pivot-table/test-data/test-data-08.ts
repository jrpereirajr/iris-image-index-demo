export const PIVOTTABLE_TEST08 = {
  mdx: 'SELECT NON EMPTY {HEAD(NONEMPTYCROSSJOIN([HomeD].[H1].[ZIP].Members, [Measures].[Population]), 2000, SAMPLE), HEAD(NONEMPTYCROSSJOIN([HomeD].[H1].[ZIP].Members, [Measures].[Avg Population]), 2000, SAMPLE)} ON 0,[HomeD].[H1].[City].Members ON 1 FROM [Cities]',
  resp: {
    Info: {
      Error: '',
      TimeStamp: '2020-12-13 17:02:29',
      ResultsComplete: 1,
      PendingResults: 0,
      MDXText: 'SELECT NON EMPTY {HEAD(NONEMPTYCROSSJOIN([HOMED].[H1].[ZIP].MEMBERS,[MEASURES].[POPULATION]),2000,SAMPLE),HEAD(NONEMPTYCROSSJOIN([HOMED].[H1].[ZIP].MEMBERS,[MEASURES].[AVG POPULATION]),2000,SAMPLE)} ON 0,[HOMED].[H1].[CITY].MEMBERS ON 1 FROM [CITIES]',
      QueryKey: 'ptbr245098857',
      CubeKey: 'CITIES',
      QueryID: 'CITIES||ptbr245098857',
      Cube: 'Cities',
      Pivot: '',
      QueryType: 'SELECT',
      ListingSource: '',
  ...
  expectations: {
    columnRows: 2,
    columnRowsCells: [
      'City', '32006', '32007', '34577', '36711', '38928', '32006', '32007', '34577', '36711', '38928',
      'City', 'Population', 'Population', 'Population', 'Population', 'Population', 'Avg Population', 'Avg Population', 'Avg Population', 'Avg Population', 'Avg Population'
    ],
    columnRowsCount: 22,
    rows: 9,
    cells: [
